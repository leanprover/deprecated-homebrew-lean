...
class Lean < Formula
  ...
  version "0.2.0-git5d4b6a3de22d239dac01a46963672851a027b952"

  bottle do
    root_url 'https://leanprover.github.io/homebrew-lean'
    sha1 '26f458125fada4a73530a14f10eaae755072392c' => :yosemite
    sha1 '2054ac151d4dbb9060bda3b6693985b085e05205' => :mavericks
  end
